...
|------|:-:|:-:|:-:|:-:|
| **總報酬** | **+60.52%** | +35.18% | +24.16% | +3.03% |
| **年化報酬** | **53.28%** | 44.69% | 38.91% | 15.01% |
| **年化波動率** | 32.02% | 31.27% | 28.90% | 18.01% |
| **Sharpe 比** | **1.539** | 1.302 | 1.208 | 0.612 |
| **Sortino 比** | **2.108** | 1.777 | 1.602 | 0.734 |
| **最大回撤** | -46.41% | -47.24% | -49.38% | -33.72% |
| **Calmar 比** | **1.148** | 0.946 | 0.788 | 0.445 |
| **獲勝率（日）** | 56.02% | 56.06% | 56.22% | 55.53% |
| **平均換手率** | 1.99% | 1.04% | 0.04% | 0% |
| **Beta（vs SPY）** | 0.495 | 0.408 | 0.352 | 1.000 |
| **年化 Alpha** | 87.20% | 72.35% | 62.31% | 0% |

**回測期間**：2015-01-01 至 2025-12-31（約 10 年，有效回測自 2016 年起）

### 12.2 主要發現

1. **Black-Litterman 顯著優於基準**：總報酬 60.52%，為 SPY 的 20 倍，顯示 Mag7 集中策略 + LLM 觀點的有效性。
